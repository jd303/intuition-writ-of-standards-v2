	...
	return (
		<>
			...
			<div className={st.beltValues}>
				<TextField label="Usable" type="number" initialValue={2 + character.item_belt.bonus_usable} disabled={true} />
			...
			<div className={st.beltValues}>
				<TextField label="Throwable" type="number" initialValue={3 + character.item_belt.bonus_throwable} disabled={true} />
