...
import { setMagicSourceSelection, setSpellLevelSelection, setSpellSchoolSelection, setSpellsSearch } from '../../features/search/searchSlice';
...
function MagicSpellsPage() {
	...
	const filteredSpells = useMemo(() => {
		...
		return spellsSchoolFiltered;
	}, [spells, spellsSearch, spellLevelSelection, magicSourceSelection, spellSchoolSelection]);
