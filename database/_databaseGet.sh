...
firebase database:get /psionic_powers > ./database/psionic_powers.json;
...
python -m json.tool ./database/psionic_powers.json > ./database/psionic_powers.formatted.json;
...
rm ./database/psionic_powers.json;
